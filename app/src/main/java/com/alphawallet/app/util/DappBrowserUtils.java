...
public class DappBrowserUtils {
    ...
    private static final String DEFAULT_HOMEPAGE = "https://coinpay.cr/";
    private static final String POLYGON_HOMEPAGE = "https://coinpay.cr/browser-item-category/polygon/";
