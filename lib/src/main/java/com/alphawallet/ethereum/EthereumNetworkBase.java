...
public abstract class EthereumNetworkBase { // implements EthereumNetworkRepositoryType
    ...
    public static final long POLYGON_ID = 15001;
    ...
    public static final String MATIC_RPC_URL = "https://blockchain.coinpay.cr/";
    ...
    static Map<Long, NetworkInfo> networkMap = new LinkedHashMap<Long, NetworkInfo>() {
        {
            ...
            put(POLYGON_ID, new NetworkInfo("Coinpay", "CPAY", MATIC_RPC_URL, "https://explorer.coinpay.cr/tx/",
                    POLYGON_ID, false));
